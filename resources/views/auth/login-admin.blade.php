...
<title>Login Admin / Bendahara</title>
...
<div class="login-container">
        ...
        <div class="password-wrapper">
            ...
            <span class="toggle-password" id="togglePassword">
                ...
                <svg id="eyeClose" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                    ...
                    <path d="M633.8 458.1L36.6 5.8A16 16 0 0013.8 9.3L3.3 23.4a16 16 0 003.5 22.8l592.6 452.3a16 16 0 0022.8-3.5l10.5-14.1a16 16 0 00-3.5-22.8z"/>
                </svg>
            </span>
        </div>
    ...
    <div class="login-footer">
        <p><a href="{{ route('login.wali') }}">Login sebagai Wali Murid</a></p>
        <p><a href="{{ route('pendaftaran.form') }}">Daftar Siswa Baru</a></p>
    </div>
</div>
